...
export default class CapaPuntosInteres {
    ...
    obtenerIcono(
        ...
        if (
            tipo.includes('UNIVERSIDAD') ||
            tipo.includes('EDUCACION') ||
            tipo.includes('FACULTAD')
        ) {
        ...
        if (
            tipo.includes('EDIFICIO') ||
            tipo.includes('COMPLEJO')
        ) {
    ...
    mostrarInformacion(
        ...
        this.panelInformacion.className =
        ...
        this.panelInformacion.appendChild(
            botonCerrar
        );
    ...
    crearEstilos() {
        ...
        const id =
            'metronet-puntos-interes-estilos';
