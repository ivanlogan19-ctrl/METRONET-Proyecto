...
export default class SelectorZonas {
    ...
    cambiarSeleccionZona(
        ...
        if (seleccionada) {
            ...
            this.zonasSeleccionadas.add(
                zona
            );

        } else {

            this.zonasSeleccionadas.delete(
                zona
            );
        }
    ...
    crearEstilos() {
        ...
        if (
            document.getElementById(
                'metronet-selector-zonas-styles'
            )
        ) {
            return;
        }
